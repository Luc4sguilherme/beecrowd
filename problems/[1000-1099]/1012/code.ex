...
area_of_right_triangle = calculate_area_of_right_triangle.(a, c) |> parse_mantissa.(3)
area_of_circle = calculate_area_of_circle.(c) |> parse_mantissa.(3)
area_of_trapezium = calculate_area_of_trapezium.(a, b, c) |> parse_mantissa.(3)
area_of_square = calculate_area_of_square.(b) |> parse_mantissa.(3)
area_of_rectangle = calculate_area_of_rectangle.(a, b) |> parse_mantissa.(3)
